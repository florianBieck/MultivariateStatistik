...
@StepScope
@Slf4j
public class RegressionH2Reader implements ItemReader<OLSMultipleLinearRegression> {
    ...
    public OLSMultipleLinearRegression read() throws Exception, UnexpectedInputException, ParseException, NonTransientResourceException {
        ...
        List<Result> results = (List<Result>) resultRepository
                .findAllByChangeIntervalIsNotNullAndPositivityIsNotNullAndRetweetCountIsNotNullAndHourInterval(hourinterval);
